...
| DEV-200 Tier-A count audit | Aggregate absolute count delta vs. Python oracle: 0.30% XML side, 1.53% kern side. Top outliers are documented importer differences. |
| DEV-200 Tier A+B correlation | Cross-importer raw Spearman: 0.8433, above the 0.80 regression floor. Same-format engine-isolating Spearman on healthy sources: 0.9998. |
