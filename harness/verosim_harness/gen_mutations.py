...
- converter21 represents an unbeamed flag as beaming ['partial'], so flags
  cost 1 in modes that include Beams.
...
CASES: list[dict] = [
    ...
    dict(id="mono_pitch_letter", base="mono.krn", mode="active",
    ...
    dict(id="mono_octave_up", base="mono.krn", mode="active",
         edits=[dict(line=6, find="4c", replace="4cc")],
         expected_cost=4, expected_ops={"notedel": 1, "noteins": 1},
         rationale="Octave change: C5 vs C4 differ in pitches[0][0]; del(2) + ins(2)."),
    dict(id="mono_accidental_sharp", base="mono.krn", mode="active",
    ...
    dict(id="mono_head_change", base="mono.krn", mode="active",
    ...
    dict(id="mono_note_delete_end", base="mono.krn", mode="active",
    ...
    dict(id="mono_rest_for_note", base="mono.krn", mode="active",
    ...
    dict(id="mono_flag_eighth", base="mono.krn", mode="active",
    ...
    dict(id="mono_clef", base="mono.krn", mode="active",
    ...
    dict(id="mono_timesig_num", base="mono.krn", mode="active",
    ...
    dict(id="mono_timesig_denom", base="mono.krn", mode="active",
         edits=[dict(line=4, find="*M4/4", replace="*M4/2")],
         expected_cost=2, expected_ops={"extrainfoedit": 1},
         rationale="Denominator component changed = del+add = 2."),
    dict(id="mono_keysig_add", base="mono.krn", mode="active",
    ...
    dict(id="mono_barline_drop", base="mono.krn", mode="active",
    ...
    dict(id="mono_artic_staccato", base="mono.krn", mode="active",
    ...
    dict(id="mono_tie_hanging", base="mono.krn", mode="active",
         edits=[dict(line=12, find="4g", replace="[4g")],
    ...
    dict(id="mono_slur", base="mono.krn", mode="active",
    ...
    dict(id="keysig_f_natural", base="keysig.krn", mode="active",
    ...
    dict(id="keysig_f_explicit_n", base="keysig.krn", mode="active",
    ...
    dict(id="keysig_remove", base="keysig.krn", mode="active",
    ...
    dict(id="keysig_add_csharp", base="keysig.krn", mode="active",
    ...
    dict(id="keysig_to_flats", base="keysig.krn", mode="active",
    ...
    dict(id="keysig_gsharp", base="keysig.krn", mode="active",
         edits=[dict(line=12, find="4g", replace="4g#")],
         expected_cost=1, expected_ops={"accidentdel": 1},
         rationale="Sharp not in the key: displayed, cost 1."),
    dict(id="keysig_clef_bass", base="keysig.krn", mode="active",
    ...
    dict(id="accid_carry_break", base="accid.krn", mode="active",
    ...
    dict(id="accid_carrier_change", base="accid.krn", mode="active",
    ...
    dict(id="accid_natural_to_carried_flat", base="accid.krn", mode="active",
    ...
    dict(id="accid_flat_to_sharp", base="accid.krn", mode="active",
    ...
    dict(id="accid_flat_drop", base="accid.krn", mode="active",
         edits=[dict(line=15, find="4B-", replace="4B")],
         expected_cost=1, expected_ops={"accidentins": 1},
    ...
    dict(id="accid_tie_f_sharps", base="accid.krn", mode="active",
         edits=[dict(line=9, find="8f#", replace="[8f#"),
    ...
    dict(id="accid_artic_accent", base="accid.krn", mode="active",
    ...
    dict(id="chords_dot_shift", base="chords.krn", mode="active",
    ...
    dict(id="chords_halves_to_dotted_quarters", base="chords.krn", mode="active",
    ...
    dict(id="chords_artic_staccato", base="chords.krn", mode="active",
         edits=[dict(line=11, find="4g", replace="4g'")],
         expected_cost=1, expected_ops={"delarticulation": 1},
         rationale="Staccato on a plain note in the chords file: +1."),

    # ---------------- grand.krn: two staves ----------------
    dict(id="grand_bass_pitch", base="grand.krn", mode="active",
    ...
    dict(id="grand_bass_delete", base="grand.krn", mode="active",
         ...
         verovio_divergence="Rhythm-broken kern (bass spine short of the treble): humlib "
                   ...
                   "gate per D6 (active validation record)."),
    dict(id="grand_whole_to_half", base="grand.krn", mode="active",
    ...
    # ---------------- tuplet.krn: tuplets ----------------
    dict(id="tuplet_pitch", base="tuplet.krn", mode="active",
    ...
    dict(id="tuplet_dot_add_mid", base="tuplet.krn", mode="active",
    ...
    dict(id="tuplet_del_last_note", base="tuplet.krn", mode="active",
...
def build() -> tuple[dict, dict[str, str]]:
    ...
    manifest = {
        ...
        "mode_details": {name: METRIC_MODES[name] for name in sorted({c["mode"] for c in CASES})},
