...
vendored-enum drift.
  ...
  experimental = active | Directions | Ottavas | Arpeggios   = 13299

The Lyrics bit (16384) is never set (v1 excludes lyrics). Directions bundles
dynamics/wedges with tempo/text/rehearsal/pedal marks; Ottavas and Arpeggios
are separate bits. Experimental remains a broader diagnostic mode rather than
